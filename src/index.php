...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover" style="background-image: url(https://source.unsplash.com/1600x900/?medicine,pharmacy);">
      <div class="container">
        <div class="row">
          <div class="col-md-5">
            <h1 class="mb-2">Purchase Prescription Drugs Online</h1>
              <p class="mb-4"><b>HomeMeds is completely committed to providing quality when it comes to your prescription medications.</b>  </p>
              <p>
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-12 col-lg-5 justify-content-center">
            <p>HomeMeds pharmacists are unique because they understand the importance of personalized care. On top of receiving a comprehensive education needed to meet state licensing requirements, all our pharmacists are professionally certified to provide immunizations. What sets our pharmacists apart from the rest are their daily interactions with you, our customers. Because at HomeMeds, we care.</p>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row align-items-center">
        <div class="col-md-12 col-lg-5 justify-content-center">
            <p>During this pandemic HomeMeds deliver medicine at your door step. We practice socail distancing norms for our customers for the healthy intteractions.</p>
            <p><a href="about.php" class="btn btn-primary btn-sm">Know more</a></p>
          </div>
          <div class="col-md-12 col-lg-7">
            <img src="images/section.jpg" class="img-fluid rounded" style="    height: 550px;
    width: 700px">
          </div>
        </div>
      </div>
		  ...
		  <div class="row">
			<div class="col-lg-6">
			  <div class="features-icons-item mx-auto mb-5">
				...
				<h3>Free Shipping</h3>
				<p>HomeMeds Offers Free Shipping with No Minimum</p>
			  </div>
			</div>
			<div class="col-lg-6">
			  <div class="features-icons-item mx-auto mb-5">
				...
				<p>Get answers from a pharmacist now. Contact us on +91 9876543210.
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-12">
			...
			<div class="panel">
			  <p>If your question is of an urgent nature, please contact your local healthcare provider or hospital emergency room. If this is a medical emergency, contact 112.</p>
			</div>
			
			<button class="accordion">Can you tell me if my prescription is ready for pick-up?</button>
			<div class="panel">
			  <p>You will need to contact your local HomeMeds pharmacy to see if your prescription is ready. My Pharmacy members can also see if their prescription is ready by logging in to their account and/or signing up to receive prescription reminders via email or text message.</p>
			</div>
			...
			<button class="accordion">Does HomeMeds carry a particular product?</button>
			<div class="panel">
			  <p>You will need to contact your local HomeMeds store for inventory information. If the product is not in stock, the pharmacist may be able to place a special order.</p>
			</div>

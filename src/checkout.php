          ...
          <div class="row align-items-center">
            ...
            <div class="text-right col-6 col-md-4 order-3 order-md-3">
              <div class="site-top-icons">
                <ul>
                  <li><a href="signup.php"><span class="icon glyphicon glyphicon-user">User</span></a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 mb-5 mb-md-0">
			...
			?>
	          <form id="order_details" action="payscript.php">
              ...
              <div class="col-md-12">
				...
				?>
				  ...
				  <div class="border p-3 mb-3">
					<button class="accordion"><a href="thankyou.php">Cash On Delivery</a></button>
                  </div>

                  <div class="form-group" action="payscript.php">
